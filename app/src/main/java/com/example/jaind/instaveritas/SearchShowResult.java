...
public class SearchShowResult extends Activity {
    static private SearchShowAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.serchshowresult);
        conetxt = this;
        ...
        adapter = new SearchShowAdapter(conetxt, sd);
